...
/* Init ASN.1 context */
 ...
 //	p_event->t=1;
	...
	/* Initialise this list and take appropriate structure item to append into the list   */
	    ...
	    event_item->messageDirection=E2SM_RC_incoming;
	    event_item->ric_eventTriggerCondition_ID=145;
	    ...
	    event_item->messageType.u.messageType_Choice_NI->m.nI_IdentifierPresent=0;
	    event_item->messageType.u.messageType_Choice_NI->m.nI_MessagePresent=1;
	    event_item->messageType.u.messageType_Choice_NI->nI_Type=0;
	    if(flag==0)
...
/*	E2SM_KPM_ActionDefinition		  *p_action=NULL;
	...
	//asn1Print_E2SM_KPM_ActionDefinition("Action Definition",p_action);
        p_action->actionDefinition_formats.u.actionDefinition_Format3->granulPeriod=10000;
	p_action->ric_Style_Type=3;
	E2SM_KPM_MeasurementCondItem              *meas=NULL;
	
	int      a1=0;
        E2SM_KPM_MatchingCondItem                 *Match=NULL;
	OSRTDListNode        *Node=NULL;
	Node=NULL;
		...
		meas->measType.u.measID=301;
            	rtxDListAllocNodeAndData(&asn1_ctx,
                 E2SM_KPM_MatchingCondItem ,
                  &Node1,&Match);
		  Match->t=2;
		  Match->u.testCondInfo=rtxMemAllocTypeZ(&asn1_ctx,E2SM_KPM_TestCondInfo);
		  Match->u.testCondInfo->testType.t=1;
		  Match->u.testCondInfo->testType.u.gBR=1;
            	  rtxDListAppendNode (
                  &(meas->matchingCond),
                  Node1);
...
//	asn1Print_e2ap_RICactions_ToBeSetup_List("ricAction_ToBeSetup_List",&(p_value_ie3->ricAction_ToBeSetup_List));	
	...
	{  
	    ...
	    listE->value.u._e2ap_RICaction_ToBeSetup_ItemIEs_1->m.ricActionDefinitionPresent=0;
...
int i=0;
	...
	break;
        ...
        printf("==========Initiating Encoding of RIC Subscription Request 1=========\n\n\n");
   while(1)
	{
	if(pp_asn_msg1==NULL)
	{
...
pp_asn_msg1=NULL ;    */            
        printf("==========Initiating Encoding of RIC Subscription Request 2=========\n\n\n");
 /*   while(1)
	{
		if(pp_asn_msg1==NULL)
		{
