...
#define MAC_SLOT_INDICATION                     0x01
#define MAC_TIMING_ADVANCE_REPORT               0x02
#define RLC_TRAFFIC_REPORT                      0x04
#define MAC_DL_CHANNEL_QUALITY_REPORT           0x08
#define MAC_UL_CHANNEL_ESTIMATE_REPORT          0x10
...
#define RIC_MODULE_ID   28 // (E2CU_MIN_EXT_MODULE_ID + 1)
/*sctp parameters stop*/
/* E2_NODE_CHANGE */
#define MAX_PLMN_ID_BYTES   		3
#define GNB_ID_OCTET_SIZE   		4
#define MAX_CELL_IDENTITY_OCTETS	5
