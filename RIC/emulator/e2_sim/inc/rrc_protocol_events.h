 ...
 *
 * ******************************************************************************/
#ifndef _GNB_PROTOCOL_EVENTS_H_
#define _GNB_PROTOCOL_EVENTS_H_
...
typedef struct  {
    ...
    UInt64 timeStamp;  //Not Supported
    UInt16 core_id;    //Not Supported
    UInt16 event_id; 
    UInt32 EVENT_PARAM_LROP_IN_MSECS; //Not Supported
    /* Identity of the cell */
    UInt32 EVENT_PARAM_CELL_ID;
    UInt32 EVENT_PARAM_MMES1APID;

    /* The UE identity */
    UInt32 EVENT_PARAM_RAC_UE_REF;

    /* MOM Id */
    UInt32 EVENT_PARAM_EUTRANCELL_FROID;
...
typedef struct  {
    ...
    /* Direction of message
       ...
       EVENT_VALUE_SENT=1 */
    UInt32 EVENT_PARAM_MESSAGE_DIRECTION;

    /* Number of bytes in ASN.1 coded message */
    UInt32 EVENT_PARAM_L3MESSAGE_LENGTH;

    /* L3 message if following */
    UInt8 message[0];  //Containing ASN encoded hex dump
...
typedef struct  {
    ...
    /* Error type
       ...
       EVENT_VALUE_GNB_LOGICAL_ERROR=4
       */
    UInt32 EVENT_PARAM_GNB_ERROR_TYPE;
...
typedef struct  {
    ...
    /* Reason for sending RRC Connection Reject. Currently only set when reject due to load.
       ...
       */
    UInt32 EVENT_PARAM_RRC_REJECT_CAUSE;
    ...
    /* The establishment cause received in RRC Connection request
       ...
       */
    UInt32 EVENT_PARAM_RRC_ESTABL_CAUSE;
...
typedef struct  {
    ...
    /* Type of identifier used by UE in RRC Connection Request
       ...
       */
    UInt32 EVENT_PARAM_INITIAL_UE_IDENTITY_TYPE;

    /* The identity of the UE received in RRC Connection Request  */
    UInt8 EVENT_PARAM_INITIAL_UE_IDENTITY[5];
...
typedef struct  {
    ...
    //UInt8 EVENT_PARAM_GUMMEI[8];   //Not Supported
    ...
    /* bug_8096 */
    UInt8 EVENT_PARAM_MME_IP_ADDRESS[16];
...
typedef struct  {
    ...
    /* This parameter holds all Cause-Group values that are described in the S1AP 3GPP specification, Section 9.2.1.3 in TS 36.413 or in the X2AP 3GPP specification, Section 9.2.6 in TS 36.423.     Needs to be used jointly with EVENT_PARAM_3GPP_CAUSE
       ...
       */
    UInt32 EVENT_PARAM_3GPP_CAUSE_GROUP;
...
typedef struct  {
    ...
    UInt32 EVENT_PARAM_HO_OUT_PREP_ERAB_FAIL_BITMAP;
...
typedef struct  {
    ...
    UInt32 EVENT_ARRAY_ERAB_RELEASE_FAILURE_3GPP_CAUSE_GROUP[16];
    ...
    UInt32 EVENT_ARRAY_ERAB_RELEASE_FAILURE_3GPP_CAUSE[16];
...
typedef struct  {
    ...
    UInt32 EVENT_ARRAY_ERAB_SETUP_FAILURE_3GPP_CAUSE_GROUP[16];
    ...
    UInt32 EVENT_ARRAY_ERAB_SETUP_FAILURE_3GPP_CAUSE[16];
...
typedef struct  {
    ...
    /* Describes which RRC message it is
       ...
       */
    UInt32 EVENT_PARAM_RRC_MESSAGE_ID;
...
typedef struct  {
    ...
    UInt8 EVENT_PARAM_IP_ADDRESS[16];
...
typedef struct  {
    ...
    /* The result of the S1AP Setup procedure
       ...
       */
    UInt32 EVENT_PARAM_S1_SETUP_RESULT;
    ...
    /* MME name  */
    UInt8 EVENT_PARAM_MME_NAME[150];
...
typedef struct  {
    ...
    UInt32 EVENT_ARRAY_ERAB_SETUP_REQ_ARP[16];

    /* ARP PCI  for each E-RAB in the request. */
    UInt32 EVENT_ARRAY_ERAB_SETUP_REQ_PCI[16];

    /* ARP PVI  for each E-RAB in the request. */
    UInt32 EVENT_ARRAY_ERAB_SETUP_REQ_PVI[16];
...
typedef struct  {
    ...
    UInt8 EVENT_PARAM_RRC_MESSAGE_DISCARDED[RRC_MESSAGE_DISCARDED_SIZE];
