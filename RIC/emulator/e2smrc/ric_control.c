...
/* Init ASN.1 context */
   ...
   *p_call = 156;  
   ...
   memset(p_head_msg,0,E2CU_ASN1_BUFFER_LENGTH);
	...
	p_header->ric_controlHeader_formats.u.controlHeader_Format1->ric_ControlDecision=0;
...
//	p_header->ric_controlHeader_formats.u.controlHeader_Format1->ueID.t=1;
 ...
 p_header->ric_controlHeader_formats.u.controlHeader_Format1->ueID.u.gNB_UEID->m.gNB_CU_UE_F1AP_ID_ListPresent=1;
	...
	if(header!=NULL && &header->ric_indicationHeader_formats.t!=NULL)
	{
	printf("!st fn call\n\n\n");	
   ...
   p_event_msg = malloc(E2CU_ASN1_BUFFER_LENGTH);
	...
	if(header!=NULL)
	{	
	pnode=header->ric_indicationHeader_formats.u.indicationHeader_Format2->ueID.u.gNB_UEID->gNB_CU_UE_F1AP_ID_List.head;
	f1ap_item=pnode->data;
	}
	else
	{
	f1ap_item->gNB_CU_UE_F1AP_ID=1234;	
	}
  ...
  rtxDListAppendNode (&p_header->ric_controlHeader_formats.u.controlHeader_Format1->ueID.u.gNB_UEID->gNB_CU_UE_F1AP_ID_List,
	...
	p_header->ric_controlHeader_formats.u.controlHeader_Format1->ric_Style_Type=4;
	p_header->ric_controlHeader_formats.u.controlHeader_Format1->ric_ControlAction_ID=1;

	 //p_header->ric_controlHeader_formats.u.controlHeader_Format1->ric_ControlDecision=E2SM_RC_reject_1;
	 p_header->ric_controlHeader_formats.u.controlHeader_Format1->ric_ControlDecision=REJECT_UE;                   //ACCEPT_UE          
...
asn1Print_E2SM_RC_ControlHeader("Control header",p_header);	
	...
	*p_msg_len = (UInt16)pe_GetMsgLen(&asn1_ctx);
	...
	for(i=0 ; i<=6; i++)                // loop should be i<=6 times
	{
		...
		Data->value.u._e2ap_RICcontrolRequest_IEs_1->ricInstanceID=55068;      //55068
		//Data->value.u._e2ap_RICcontrolRequest_IEs_1->ricInstanceID=55;
